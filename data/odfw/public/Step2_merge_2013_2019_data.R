...
# Things to do:
# Add Columbia River data
# Add species group (Fish, Crustacean, Mollusc, Other Invertebrate, etc)
# Add numeric month
# Sort by something
# Confirm that ports are correct
# Map ports
# Add port complex
...
# Export data
write.csv(data, file=file.path(outputdir, "ODFW_2013_2019_landings_by_port_month_species.csv"), row.names=F)
