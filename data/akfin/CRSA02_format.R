...
# Read data
data_orig <- read.csv(file.path(indir, "CRSAFEEXEC02-2009---2020.csv"), as.is=T)


# Format data
################################################################################

# Finifhs renameing columns
...
# Export data
saveRDS(data, file=file.path(outdir, "CRSA02_2009_2020_crab_sector_employment.Rds"))
